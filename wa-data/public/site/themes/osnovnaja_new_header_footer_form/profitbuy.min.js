...
//SHOW MORE TAGS .etc
    ...
    showMore.prototype.onResize = function() {
        if ( MatchMedia("only screen and (min-width: 1201px)") ) {
...
$(document).ready(function() {
    ...
    $('.a-filter-link').click(function () {
        $(this).closest('.at-stylize-label').click();
        return false;
    });


   if($('input[type=checkbox]').attr('class') != 'ac-checkbox-container') {
    ...
    $(window).resize(function(){
        if ( !(MatchMedia("only screen and (max-width: 1201px)")) ) {
...
( function ($, undefined) {
    ...
    $.at.pL({ label: 'jquery.maskinput', success: bindEvents });
