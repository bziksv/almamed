...
$(document).ready(function () {
    ...
    function initProductCarousels() {
        ...
        $(".product-list.thumbs.carousel:not(.owl-loaded)").each(function() {
            $(this).owlCarousel({
                dots: false,
                items: 1,
                nav: true,
                ...
                responsive: {
                    ...
                    481: { items: 2 },
                    741: { items: 3 },
                    993: { items: $('.without-sidebar').length == 0 ? 4 : 3 },
                    1281: { items: $('.without-sidebar').length == 0 ? 5 : 4 }
                }
            });
        });
        return true;
